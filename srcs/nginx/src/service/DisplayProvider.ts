...
import { HazardousDisplay } from './HazardousDisplay.js';

export class DisplayProvider {
  private gameScreen: GameDisplay;
  private hazardousScreen: HazardousDisplay;
  ...
  constructor() {
    ...
    this.hazardousScreen = new HazardousDisplay();
  }
  ...
  private setupEventListeners(): void {
    ...
    const hazardousBtn = document.getElementById('hazardousBtn');
    if (hazardousBtn) {
      hazardousBtn.addEventListener('click', () => this.hazardousScreen.display());
    }
  }
}
